...
% radius = 50;   % radius = 110, 50, 30 work well for jupiter.jpg
% top_k = 1;
...
% top_k = 19;   % egg has many small circles. use large top_k

% your image example
im = imread('bubbles.jpeg');
save_filename = 'my_image_circles.png';
radius = 100;   % you need to find the right radius for your image
